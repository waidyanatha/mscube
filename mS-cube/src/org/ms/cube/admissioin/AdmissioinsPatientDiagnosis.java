 ...
 * @author Madhuka
 */
public class AdmissioinsPatientDiagnosis implements CommandListener, ItemStateListener {
    ...
    public AdmissioinsPatientDiagnosis(MsCube medAdminList, AdmisionData ad) {

        this.admisionData = ad;
        System.out.println("Admissioins PatientDiagnosis pname" + admisionData.getPatientName());
...
//    }
    ...
    public void backCom() {
        PatientCaseDetails patientCaseDetails = new PatientCaseDetails(medAdminList,admisionData);
        medAdminList.display.setCurrent(patientCaseDetails.form);
    }
    ...
    public void goNextLab() {
        LaboratoryTestInvestigations laboratoryTestInvestigations;
        laboratoryTestInvestigations = new LaboratoryTestInvestigations(medAdminList,admisionData );
