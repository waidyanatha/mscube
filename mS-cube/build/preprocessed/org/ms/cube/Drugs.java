...
public class Drugs implements CommandListener, ItemStateListener {
    ...
    public Drugs(MsCube medAdminList) {
        ...
        try {
            ...
            out = new TextField("", "", 200, TextField.ANY);
            form.append(code);
            form.append(details);
            form.append(quty);
            form.append(out);
...
readDataRMS();
            Connector connector = new Connector();
            //http://localhost:9763/mscube/view/drugs.jag?code=1&uName=2&quty=37&hospital=Bihalpola-CD
            JSONArray a = new JSONArray(connector.getContain("view/drugs.jag?code="+codeName+"&uName="+MsCube.Username+"&quty="+qty+"&hospital="+MsCube.Hospital));
